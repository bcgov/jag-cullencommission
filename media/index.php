...
<div class="ExpandableSectionAccordion">
    ...
    <div class="ExpandableSection" id="ExpandableSectionContent16">
        ...
        <p>My purpose in communicating with you at this time and in this way is to explain that although the Commission is continuing to fulfil its mandate through this very unsettled time, we are doing so in a manner that recognizes the overarching priority of the COVID-19 crisis and the need to fully support efforts to limit the spread of the virus. Our desire to proceed rests on the precept that in the fullness of time, the work we do now will benefit the social and economic well-being of the province. We will only continue with our work through this period so long as it can be done effectively, safely, and without compromising the rights or interests of those affected by the Inquiry.</p>
