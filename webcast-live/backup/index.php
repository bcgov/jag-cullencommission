...
if ($found) {
    echo '<p style="text-align: center; font-size: 2rem"><strong>Witness Exclusion Order In Effect.</strong></p><p style="text-align: center"><em>If you have been notified that you will be testifying, the Commissioner has directed that, unless you have permission, you may not view hearings, read transcripts or review exhibits for the hearings beginning October 26, 2020, onwards.</em></p><div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://vimeo.com/event/62773/embed" style="border:0;position:absolute;top:0;left:0;width:100%;height:100%;" webkitallowfullscreen allowfullscreen frameborder="no" width="720" height="405"></iframe></div>' . "\n";
} else {
