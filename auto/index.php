...
if ($hour >= 14 && $hour <= 17) {
    ...
    echo '<p style="text-align: center"><strong>The hearings have not started yet.<br />They will resume on the next business day Monday-Friday, 9:30am-1:30pm<br />(except on statutory holidays).</strong></p>';
}
