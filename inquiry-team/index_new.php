...
<div class="Aside2Col">
    <div class="AsideNew AsideNewGreen">
        <p class="AsideNewTitle">Brock Martland, QC</p>
    ...
    <div class="AsideNew AsideNewGreen">
        <p class="AsideNewTitle">Patrick McGowan</p>
...
<h2>Associate Commission Counsel</h2>
<div class="Aside3Col">
    <div class="AsideNew AsideNewBlue">
        <p class="AsideNewTitle">Nicholas J. Isaac</p>
        <p>Nicholas Isaac has been named as Associate Commission Counsel for the Commission of Inquiry into Money Laundering in British Columbia. Mr. Isaac is a graduate of Queen’s University, obtained his law degree from the University of Victoria, and clerked for the British Columbia Court of Appeal. After being called to the Bar in British Columbia in 2011, Mr. Isaac practised civil, constitutional and administrative litigation with a major national firm in Vancouver, where he gained extensive trial experience.</p>
        <p>Mr. Isaac subsequently became litigation counsel in the Enforcement Division of the British Columbia Securities Commission, handling cases involving various forms of market misconduct, including securities fraud, market manipulation, and insider trading.</p>
        <p>Mr. Isaac has argued cases at all level of courts in British Columbia and has appeared before various administrative tribunals.</p>
    </div>
    <div class="AsideNew AsideNewBlue">
        <p class="AsideNewTitle">Alison M. Latimer</p>
    ...
    <div class="AsideNew AsideNewBlue">
        <p class="AsideNewTitle">Eileen Patel</p>
        <p>Eileen Patel joins the team as Associate Commission Counsel. She was a partner at a boutique Vancouver civil litigation firm before joining the Commission, and practises civil litigation, with a focus on commercial and administrative law. She has appeared at trial and on appeal in all levels of court in British Columbia as well as at the Supreme Court of Canada. She has contributed to a number of CLE publications and seminars on topics such as administrative law, practice, and securities litigation.</p>
        <p>Ms. Patel is a graduate of UBC Law, where she was the Law Society gold medallist and a Wesbrook Scholar, and clerked at the British Columbia Court of Appeal and at the Supreme Court of Canada for the Right Honourable Chief Justice Beverley McLachlin before starting her legal career.</p>
    </div>
</div>
<br class="ClearFloats">
<h2>Junior Commission Counsel</h2>
<div class="Aside3Col">
    <div class="AsideNew AsideNewYellow">
        <p class="AsideNewTitle">Steven Davis</p>
    ...
    <div class="AsideNew AsideNewYellow">
        <p class="AsideNewTitle">Kyle McCleery</p>
    ...
    <div class="AsideNew AsideNewYellow">
        <p class="AsideNewTitle">Kelsey Rose</p>
